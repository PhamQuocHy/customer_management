                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse menu-second" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link df-between" href="pages/ui-features/buttons.html">Buttons
                                    <span class="show-icon--submenu">
                                        <i class="mdi mdi-cube-outline position-icon"> </i>
                                    </span>
                                </a>
                            </li>
                            <li class="nav-item df-between">
                                <a class="nav-link" href="pages/ui-features/dropdowns.html">Dropdowns
                                    <span class="show-icon--submenu">
