                ...
                <div class="form-flex--wrapper">
                  <div class="from-mn-warpper mb-20">
                    ...
                    <div class="input-group">
                      ...
                      <textarea required class="ctrl-input" type="text" id="great_content" name="great_content"
                        cols="10" rows="10"><?php echo htmlspecialchars($greats['great_content']); ?></textarea>
                    </div>
